...
_C.model.ce_lambda = 0.5
_C.model.hkd_lambda = 0.15
_C.model.rkd_lambda = 0.5
# feature KD
_C.model.fkd_lambda = 1e-1
_C.model.use_ABD_loss = False
_C.model.use_cls_loss = True

_C.model.featureKD = CN()
_C.model.featureKD.use_featureKD = True
_C.model.featureKD.use_ABD_KD = True
