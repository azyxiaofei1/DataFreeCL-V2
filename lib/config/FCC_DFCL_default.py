...
_C.model.loss_type = "ABD"
_C.model.use_post_LAKD = False
_C.model.T = 2.

# logit KD:
_C.model.use_localCE = True
_C.model.use_localKD = True
_C.model.use_finetune = False
_C.model.use_feature_norm = False
_C.model.use_finetune_FCC = False

_C.model.gamma = 0.5
_C.model.kd_lambda = 1.

_C.model.use_FCCKD = False
...
# classification loss:
_C.new_model.loss_type = "ABD"

# logit KD:
_C.new_model.T = 2.
_C.new_model.kd_lambda = 1.
_C.new_model.ce_lambda = 1.

_C.new_model.hkd_lambda = 1.

# rkd:
_C.new_model.rkd_lambda = 1.
...
_C.new_model.finetune = CN()
_C.new_model.finetune.MAX_EPOCH = 120
_C.new_model.finetune.BATCH_SIZE = 128
_C.new_model.finetune.SHUFFLE = True
_C.new_model.finetune.NUM_WORKERS = 4
# ----- OPTIMIZER -----
_C.new_model.finetune.BASE_LR = 0.1
_C.new_model.finetune.TYPE = "SGD"
_C.new_model.finetune.MOMENTUM = 0.9
_C.new_model.finetune.WEIGHT_DECAY = 1e-4
# ----- LR_SCHEDULER -----
_C.new_model.finetune.LR_TYPE = "multistep"
_C.new_model.finetune.LR_STEP = [30, 60]
_C.new_model.finetune.LR_FACTOR = 0.1
_C.new_model.finetune.WARM_EPOCH = 5
