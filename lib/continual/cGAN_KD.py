...
class cGAN_KD(cGAN_gen):

    def __init__(self, cfg, dataset_handler, logger):
        super(cGAN_KD, self).__init__(cfg, dataset_handler, logger)
    ...
    def train_main(self, train_dataset, active_classes_num):
        ...
        self.cgan_KD(train_dataset)

    def cgan_KD(self, train_dataset):
    ...
    def train_student(self, train_dataset):
        ...
        for epoch in range(1, self.cfg.student.TRAIN.MAX_EPOCH + 1):
            ...
            for x, y in train_loader:
                ...
                x_replay, y_replay = self.sample(self.teacher, len(x), labels=y)
    ...
    def construct_pseudo_datasets(self, pseudo_dataset_root, active_classes_num):
        ...
        while min_class_sample < 100:
            x_replay, y_replay = self.sample(self.teacher, 128)
